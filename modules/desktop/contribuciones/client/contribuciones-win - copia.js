        ...
        this.gridContribuciones = new Ext.grid.EditorGridPanel({
            ...
            columns: [
                ...
                },
                {
                    ...
                    sortable: true,
                    width: 22,
                    editor: comboDETIORD, renderer: contribucionesListaOrdenanza
        ...
        this.gridDocumentosReporte = new Ext.grid.EditorGridPanel({
            ...
            columns: [
                ...
                },
                {
                    ...
                    sortable: true,
                    width: 28,
                    renderer: contribucionesListaOrdenanza
                            ...
                            tbar: [
                                ...
                                '-',
                                {
                                    ...
                                    handler: function (checkbox, isChecked) {
                                        Ext.getCmp('tb_repoteContribuciones').setDisabled(!this.checked);
