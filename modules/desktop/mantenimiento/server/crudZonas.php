...
function selectMantenimientoZonas()
{
    global $os;
...
function insertMantenimientoZonas()
{
    global $os;
    $os->db->conn->query("SET NAMES 'utf8'");
...
function updateMantenimientoZonas()
{
    global $os;
    $os->db->conn->query("SET NAMES 'utf8'");
...
function deleteMantenimientoZonas()
{
    global $os;
...
switch ($_GET['operation']) {
     case 'select' :
        selectMantenimientoZonas();
        break;
    case 'insert' :
        insertMantenimientoZonas();
        break;
    case 'update' :
        updateMantenimientoZonas();
        break;
    case 'delete' :
        deleteMantenimientoZonas();
        break;
}